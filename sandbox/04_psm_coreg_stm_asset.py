...
stm_s01 = fct.stm.PSM_STM(startDate, endDate, register=True, roi_path=r'D:\PRJ_TMP\FSDA\data\NICFI_LC\lichinga.shp') \
...
stm_s02 = fct.stm.PSM_STM(startDate, endDate, register=True, roi_path=r'D:\PRJ_TMP\FSDA\data\NICFI_LC\lichinga.shp') \
...
startDate = datetime.datetime(2020, 9, 1)
endDate = datetime.datetime(2021, 8, 31)
stm_s03 = fct.stm.PSM_STM(startDate, endDate, register=True, roi_path=r'D:\PRJ_TMP\FSDA\data\NICFI_LC\lichinga.shp') \
...
task = ee.batch.Export.image.toAsset(**{
    ...
    'assetId': 'users/philipperufin/fsda_lichinga_psm_coreg_stm_2021',
    'maxPixels': 1e13
})
task.start()
