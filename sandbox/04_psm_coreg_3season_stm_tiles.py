...
for i in fids:
    ...
    collection = fct.psm.PSM_COREG(startDate, endDate, roi=roi_poly, property='system:index',
    ...
    if True:
        task = ee.batch.Export.image.toAsset(**{
            ...
            'assetId': 'users/philipperufin/fsda_tiles/fsda_tile_03deg_' + f'{int(i):03}' + '_psm_coreg_3season_stm',
            'maxPixels': 1e13
        })
        task.start()
